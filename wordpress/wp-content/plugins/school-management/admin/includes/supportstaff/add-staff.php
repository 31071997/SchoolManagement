		...
		<div class="form-body user_form"> <!-- user form -->
			<div class="row"><!-- row -->
				...
				<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 error_msg_left_margin">
					<div class="form-group input">
						<div class="col-md-12 form-control">
							<input id="zip_code" class="form-control  validate[required,custom[zipcode],minSize[4],maxSize[8]]" maxlength="15" type="text"  name="zip_code" value="<?php if($edit){ echo $user_info->zip_code;}elseif(isset($_POST['zip_code'])) echo $_POST['zip_code'];?>">
			...
			<div class="row"><!-- row -->
				<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
					<div class="form-group input">
						...
						<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 rtl_padding_0px">
