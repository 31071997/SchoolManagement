				...
				<tbody>
					...
					{ 
						...
						<tr>
							...
							<td><?php echo $retrieved_data->title;?> <i class="fa fa-info-circle fa_information_bg" data-toggle="tooltip" data-placement="top" title="<?php _e('Title','school-mgt');?>" ></i></td>
										...
										<li class="">
											...
											{ 
												...
												<li class="float_left_width_100 border_bottom_menu">
													<a href="?dashboard=user&page=homework&tab=view_student_homework&stud_homework_id=<?php echo $retrieved_data->stu_homework_id;?>" class="float_left_width_100"><i class="fa fa-eye"> </i><?php esc_html_e('Submitted Homework', 'school-mgt' ) ;?></a>
												</li>
												<?php 
											}
											?>	 
