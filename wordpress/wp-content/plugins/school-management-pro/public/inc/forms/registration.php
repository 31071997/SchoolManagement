...
if (isset($attr['school_id'])) {
	...
	// var_dump($school_registration_medium); die;
	...
	<div id="wlsm-submit-registration-section">
		...
		<form action="<?php echo esc_url(admin_url('admin-ajax.php')); ?>" method="post" id="wlsm-submit-registration-form">
			...
			<div class="wlsm-form-section">
				...
				<div class="wlsm-form-section" id="registration_school_details">
			...
			<div class="wlsm-form-section">
				...
				<?php if ($school_registration_student_type or empty($school_id)) : ?>
				...
				<?php endif ?>
					...
					<div class="wlsm-form-group wlsm-col-4">
						...
						<select name="class_id" class="wlsm-form-control wlsm_school_class wlsm_school_class_subject wlsm_school_class_activity wlsm_get_class_fees " data-nonce="<?php echo esc_attr(wp_create_nonce('get-class-sections')); ?>" id="">
				...
				<div class="wlsm-row">
					...
					<div class="wlsm-form-group wlsm-col-4" id="registration_pan">
						...
						<input type="text" name="pan" class="wlsm-form-control" id="wlsm_pan" placeholder="<?php esc_attr_e('Enter here', 'school-management'); ?>" value="">
					</div>
					<?php endif ?>
				</div>
			...
			<?php if (($school_registration_survey === true) || empty($school_id)) : ?>
				...
				<div class="wlsm-form-section" id="registration_survey">
					<div class="wlsm-row">
						<div class="wlsm-col-12">
							<div class="wlsm-form-sub-heading wlsm-font-bold">
