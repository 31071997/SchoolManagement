...
<ul class="wlsm-navigation-links">
	...
	<?php if ($school_home_work): ?>
		<li>
		<a class="wlsm-navigation-link<?php if ( 'homework' === $action ) { echo ' active'; } ?>" href="<?php echo esc_url( add_query_arg( array( 'action' => 'homework' ), $current_page_url ) ); ?>"><?php esc_html_e( 'Homework', 'school-management' ); ?></a>
	</li>
	<?php endif ?>
