			...
			<div class="wlsm-form-section">
				...
				<div class="form-row">
					<div class="form-group col-md-3">
						...
						<select name="subjects" class="form-control selectpicker" id="wlsm_subject" data-live-search="true" title="<?php esc_attr_e('Select subject', 'school-management'); ?>" data-actions-box="true" <?php if ($subject_id) {
							echo 'disabled';
						} ?>>
