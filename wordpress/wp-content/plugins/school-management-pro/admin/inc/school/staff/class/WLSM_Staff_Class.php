...
class WLSM_Staff_Class
{
	...
	{
		$current_user = WLSM_M_Role::can('edit_subjects');
	...
	{
		$current_user = WLSM_M_Role::can('view_subjects', 'manage_staff_leaves');
	...
	{
		$current_user = WLSM_M_Role::can('manage_activities');
