...
class WLSM_M {
	...
	public static function notices_query() {
		return 'SELECT n.ID, n.title, n.description, n.attachment, n.url, n.link_to, n.is_active, n.created_at, n.notice_data FROM ' . WLSM_NOTICES . ' as n

		WHERE n.is_active = 1 GROUP BY n.ID ';
	}

	public static function notices_query_api() {
		return 'SELECT n.ID, n.title, n.description, n.attachment, n.url, n.link_to, n.is_active, n.created_at, n.notice_data FROM ' . WLSM_NOTICES . ' as n
		WHERE n.is_active = 1 GROUP BY n.ID ';
	}
